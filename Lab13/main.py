...
class InfoJoc:
    ...
    def final(self):
        rez = elem_identice(self.matr[0]) or elem_identice(self.matr[1]) or elem_identice(self.matr[2]) \
              or elem_identice([self.matr[i][0] for i in range(self.NR_COLOANE)]) \
              or elem_identice([self.matr[i][1] for i in range(self.NR_COLOANE)]) \
              or elem_identice([self.matr[i][2] for i in range(self.NR_COLOANE)]) \
              or elem_identice([self.matr[i][i] for i in range(self.NR_COLOANE)]) \
              or elem_identice([self.matr[i][self.NR_COLOANE - i - 1] for i in range(self.NR_COLOANE)])
        ...
        if rez:
            ...
            # in caz contrar, jocul nu s-a terminat
        return "remiza"
    ...
    def linii_deschise(self, jucator):
        return self.linie_deschisa(self.matr[0], jucator) \
              ...
              + self.linie_deschisa([self.matr[i][0] for i in range(self.NR_COLOANE)], jucator) \
              + self.linie_deschisa([self.matr[i][1] for i in range(self.NR_COLOANE)], jucator) \
              + self.linie_deschisa([self.matr[i][2] for i in range(self.NR_COLOANE)], jucator) \
              + self.linie_deschisa([self.matr[i][i] for i in range(self.NR_COLOANE)], jucator) \
              + self.linie_deschisa([self.matr[i][self.NR_COLOANE - i - 1] for i in range(self.NR_COLOANE)], jucator)
...
def min_max(stare):
    ...
    mutariExpandate = [min_max(st) for st in stare.mutari_posibile]
